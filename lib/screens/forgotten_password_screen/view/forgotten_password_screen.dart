...
import 'package:baskent_car_app/screens/forgotten_password_screen/controller/forgotten_password_controller.dart';
...
class ForgottenPasswordScreen extends StatelessWidget {
  ...
  SizedBox textOkulNo() {
    return SizedBox(
      ...
      height: 10.h,
      child: TextField(
        controller: forgottenPasswordController.okulnoController,
    ...
    return Row(
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () {
            forgottenPasswordController.checkSchoolNumber();
          },
